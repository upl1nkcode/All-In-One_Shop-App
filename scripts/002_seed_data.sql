...
-- Run this after 001_create_schema.sql to populate the database with initial data
...
-- PRODUCTS
-- ============================================================
INSERT INTO products (id, name, description, brand_id, category_id, image_url, sizes, colors) VALUES
  (
    'd1000000-0000-0000-0000-000000000001',
    'Classic Black Hoodie',
    'Comfortable cotton blend hoodie with adjustable drawstring hood and kangaroo pocket. Perfect for casual wear and light workouts.',
    'c1000000-0000-0000-0000-000000000001', -- Nike
    'b1000000-0000-0000-0000-000000000004', -- Hoodies
  ...
  (
    ...
    'Genuine leather jacket with asymmetric zip closure. Features multiple pockets and quilted shoulder detail.',
    'c1000000-0000-0000-0000-000000000003', -- Zara
    'b1000000-0000-0000-0000-000000000005', -- Jackets
  ...
  (
    ...
    'Cargo Utility Pants',
    'Durable cargo pants with multiple pockets. Made from heavyweight cotton canvas. Available in various colors.',
    'c1000000-0000-0000-0000-000000000004', -- Carhartt
    'b1000000-0000-0000-0000-000000000006', -- Pants
    'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800&q=80',
    ARRAY['S', 'M', 'L', 'XL', 'XXL'],
    ARRAY['Green', 'Brown', 'Black']
  ),
  (
    'd1000000-0000-0000-0000-000000000004',
    'Air Max 270 Sneakers',
    'Iconic Nike Air Max 270 with large Air unit in the heel. Breathable mesh upper with synthetic overlays.',
    'c1000000-0000-0000-0000-000000000001', -- Nike
    'b1000000-0000-0000-0000-000000000003', -- Sneakers
  ...
  (
    ...
    'Relaxed fit cotton t-shirt with bold graphic print. Features ribbed crew neck and dropped shoulders.',
    'c1000000-0000-0000-0000-000000000002', -- Adidas
    'b1000000-0000-0000-0000-000000000007', -- T-Shirts
  ...
  (
    ...
    'Classic 511 slim fit jeans in dark wash. Made from premium stretch denim with 5-pocket styling.',
    'c1000000-0000-0000-0000-000000000005', -- Levi's
    'b1000000-0000-0000-0000-000000000008', -- Jeans
  ...
  (
    ...
    'Wool Blend Coat',
    'Elegant double-breasted coat in wool blend. Features notch lapels, side pockets and full lining.',
    'c1000000-0000-0000-0000-000000000003', -- Zara
    'b1000000-0000-0000-0000-000000000009', -- Coats
  ...
  (
    ...
    'Running Shorts',
    'Lightweight running shorts with built-in briefs. Made from moisture-wicking fabric with reflective details.',
    'c1000000-0000-0000-0000-000000000002', -- Adidas
    'b1000000-0000-0000-0000-000000000010', -- Shorts
  ...
  (
    ...
    'Stan Smith classic white leather sneakers with green heel tab. Timeless design for everyday wear.',
    'c1000000-0000-0000-0000-000000000002', -- Adidas
    'b1000000-0000-0000-0000-000000000003', -- Sneakers
  ...
  (
    ...
    'Tech Fleece Joggers',
    'Premium tech fleece joggers with tapered fit. Features zippered pockets and adjustable waistband.',
    'c1000000-0000-0000-0000-000000000001', -- Nike
    'b1000000-0000-0000-0000-000000000006', -- Pants
  ...
  (
    ...
    'Casual bomber jacket with ribbed cuffs and hem. Features front zip closure and side pockets.',
    'c1000000-0000-0000-0000-000000000006', -- H&M
    'b1000000-0000-0000-0000-000000000005', -- Jackets
    'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800&q=80',
    ARRAY['XS', 'S', 'M', 'L', 'XL'],
    ARRAY['Black', 'Green', 'Navy']
  ),
  (
    'd1000000-0000-0000-0000-000000000012',
    'Checkered Flannel Shirt',
    'Heavy-duty flannel shirt in classic checkered pattern. Made from 100% cotton with button-down collar.',
    'c1000000-0000-0000-0000-000000000004', -- Carhartt
    'b1000000-0000-0000-0000-000000000011', -- Shirts
...
-- Lightweight Bomber Jacket prices
INSERT INTO product_prices (id, product_id, store_id, price, original_price, currency, product_url, in_stock) VALUES
...
-- Checkered Flannel Shirt prices
INSERT INTO product_prices (id, product_id, store_id, price, original_price, currency, product_url, in_stock) VALUES
